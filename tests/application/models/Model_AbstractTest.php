...
class Model_AbstractTest extends ControllerTestCase {
    ...
    /**
     * @todo Implement testSetDefaultMapperType().
     */
    public function testGetSetDefaultMapperType() {
        Model_Abstract::setDefaultMapperType($testMapperType);
		$this->assertEquals($testMapperType, Model_Abstract::getDefaultMapperType());
    }

    /**
     * @todo Implement testGetMapperType().
     */
    public function testGetSetMapperType() {
        $testMapperType = 'db';
		//Resetting current user mapper type
		$this->_object->setMapperType(null);

		//Testing getter without setting
		$this->assertEquals(Model_Abstract::getDefaultMapperType(), $this->_object->getMapperType());

		//Testing current model mapper types getter/setter
		$this->_object->setMapperType($testMapperType);
		$this->assertEquals($testMapperType, $this->_object->getMapperType());
    }
    ...
    protected function _resetModel() {
		if (!$this->_object) {
			$this->_object = $this->getMockForAbstractClass('Model_Abstract');
		}
		$this->_object->populate(array(
			'email' => $this->_email,
