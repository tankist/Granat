<?php
class Skaya_Validate_EmailNotExists extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::EXISTENT => "Email '%value%' exists or suspended",
    ...
    public function isValid($value)
    {
        ...
        $user = Skaya_Model_Service_Abstract::factory('User')->getUserByEmail($value);
        if ($user && ($user->id != $id)) {
